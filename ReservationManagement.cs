        ...
        static void HandleSelection(int option)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    break;
                case 2:
                    Reservation reservation = new(1, 3, "20-12-2023", "Dinner", new ReservationSystem.Table()
                    {
                        TableNumber = 3,
                        Capacity = 1
                    });
    ...
    private static void SearchReservations()
    {
        ...
        switch (int.TryParse(Console.ReadLine(), out int choice) ? choice : -1)
        {
            ...
            case 2:
                ...
                string date = Console.ReadLine()!;
                var reservationsOnDate = reservations.FindAll(reservation => reservation.Date == date);
