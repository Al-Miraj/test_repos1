...
class ReservationSystem
{
    ...
    public void DisplayTablesMap()
    {
        ...
        Console.WriteLine("{0," + ((Console.WindowWidth / 2) + door.Length / 2) + "}", door); // Entrance representation

        // Second row of tables (2 seats)
        DisplayTableRange(5, 8); // Tables 5-8

        Console.WriteLine("{0," + ((Console.WindowWidth / 2) + aisle.Length / 2) + "}", ""); // Space representing an aisle

        // Third row of tables (4 seats)
        DisplayTableRange(9, 12); // Tables 9-12

        Console.WriteLine("{0," + ((Console.WindowWidth / 2) + aisle.Length / 2) + "}", aisle); // Main Aisle

        // Fourth row of tables (4 and 6 seats)
    ...
    private void DisplayTableRange(int startTable, int endTable)
    {
        ...
        for (int tableNumber = startTable; tableNumber <= endTable; tableNumber++)
        {
            ...
            if (table != null)
            {
                ...
                if (table.Seats == 2) // 2-seat tables
                    Console.Write($"[ {table.TableNumber} ] ");
                else if (table.Seats == 4) // 4-seat tables
                    Console.Write($"[ {table.TableNumber} ]-[ {table.TableNumber} ] ");
                else if (table.Seats == 6) // 6-seat tables
